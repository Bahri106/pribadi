...
console.log(color('\n🐶 SAIFULCKP: Xeon ','silver'))
console.log(color('🐶 Saifulckp ','silver'))
console.log(color('🐶 WA NUMBER: 6285853570297 ','silver'))
console.log(color('  🦄sfl Bot Inc. 2022🦄','mediumseagreen'))
    ...
    console.log(color('🐶', 'cyan'), color('https://wa.me/6285853570297'))
...
store.bind(XeonBotInc.ev)
    ...
    XeonBotInc.sendMessage(callerId, { text: `Sistem Blok Otomatis!\nno telfon Bot!\nSilakan Hubungi owner Untuk Membuka Blokir Anda!`}, { quoted : pa7rick })
    await sleep(8000)
